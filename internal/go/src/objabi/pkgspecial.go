...
var runtimePkgs = []string{
	...
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/atomic",
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/exithook",
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/maps",
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/math",
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/sys",
	"github.com/gameformush/goasm-vscode/internal/go/src/runtime/syscall",

	"github.com/gameformush/goasm-vscode/internal/go/src/abi",
	"github.com/gameformush/goasm-vscode/internal/go/src/bytealg",
	"github.com/gameformush/goasm-vscode/internal/go/src/byteorder",
	"github.com/gameformush/goasm-vscode/internal/go/src/chacha8rand",
	"github.com/gameformush/goasm-vscode/internal/go/src/coverage/rtcov",
	"github.com/gameformush/goasm-vscode/internal/go/src/cpu",
	"github.com/gameformush/goasm-vscode/internal/go/src/goarch",
	"github.com/gameformush/goasm-vscode/internal/go/src/godebugs",
	"github.com/gameformush/goasm-vscode/internal/go/src/goexperiment",
	"github.com/gameformush/goasm-vscode/internal/go/src/goos",
	"github.com/gameformush/goasm-vscode/internal/go/src/profilerecord",
	"github.com/gameformush/goasm-vscode/internal/go/src/stringslite",
}
